            ...
            {/* Project 1 */}
                  <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl hover:animate-pulse">
                    ...
                    <div className="p-8">
                      ...
                      <a href="https://github.com/Swastik124/Advanced_Keylogger.git" target='_blank' rel="noopener noreferrer" className="text-blue-500 hover:text-blue-700"><u>View Project</u></a>
            ...
            <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl hover:animate-pulse">
              <div className="md:flex">
                ...
                <div className="p-8">
                  ...
                  <a href="https://github.com/Swastik124/speech-to-text-transcription.git" target='_blank' rel="noopener noreferrer" className="text-blue-500 hover:text-blue-700"><u>View Project</u></a>
                  <p className="mt-2 text-slate-500">
            ...
            <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl hover:animate-pulse md:col-span-2">
              <div className="md:flex">
                <div className="p-8">
                  ...
                  <a href="https://github.com/Swastik124/TraveloCity-Clone.git" target='_blank' rel="noopener noreferrer"className="text-blue-500 hover:text-blue-700"><u>View Project</u></a>
                  <p className="mt-2 text-slate-500">
